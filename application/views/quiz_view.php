        ...
        if ($list)
        {
            foreach ($list as $l) {
                ...
                echo '<li>
                        ...
                        <span class="span-3">
                            <a href="'.site_url().'/quiz/check/'.$l->quiz_id.'" title="Chấm điểm"><img src="'.base_url().'/images/icons/check.png" /></a>&nbsp;&nbsp;&nbsp;
                            ...
                            <a href="'.site_url().'/quiz/delete/'.$l->quiz_id.'" title="Xóa"><img src="'.base_url().'/images/icons/comment_delete.gif" /></a>
                        </span>
                      </li>'; 
            }
        }
